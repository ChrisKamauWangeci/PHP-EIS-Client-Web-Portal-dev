<x-admin-layout title="">
    ...
    <form method="get" accept-charset="utf-8" id="searchform" action="{{ route('admin.requestor-password-changes.index') }}">

        <div class="row">

            <div class="col-6 col-md-4 col-lg-3 col-xl-2 pt-2">
                <x-form.select name="action" label="Action" :options="['change' => 'change', 'reset' => 'reset']" empty="-" :default="request('action')" />
            </div>
            ...
            <div class="col-6 col-md-4 col-lg-3 col-xl-2 pt-2">
                <x-form.input name="requestor" label="Requestor" :value="request('requestor')" maxlength="50" />
            </div>
            ...
            <div class="col-6 col-md-4 col-lg-3 col-xl-2 pt-2">
                ...
                <a href="{{ route('admin.requestor-password-changes.index') }}" class="btn btn-sm btn-secondary">Reset</a>
            </div>
    ...
    <div class="table-responsive">
        <table class="table table-sm table-hover table-bordered w-auto">
            <thead>
                <tr>
                    <th><a href="{{ Request::fullUrlWithQuery(['sort_field' => 'action', 'sort_direction' => $sort_direction]) }}">Action</a></th>
                    ...
                    <th>
                        <a href="{{ Request::fullUrlWithQuery(['sort_field' => 'country_iso', 'sort_direction' => $sort_direction]) }}">Country</a>
                        <br />
                        <a href="{{ Request::fullUrlWithQuery(['sort_field' => 'region', 'sort_direction' => $sort_direction]) }}">Region</a>
                        <br />
                ...
                @foreach ($requestorPasswordChanges as $requestorPasswordChange)
                    <tr>
                        ...
                        <td nowrap>
                            ...
                            {{ $requestorPasswordChange->country_iso }} {{ $requestorPasswordChange->region_iso }} {{ $requestorPasswordChange->city }}
                        </td>
                        <td nowrap>{{ $requestorPasswordChange->created_at }}</td>
                        <td>
                            <a href="{{ route('admin.requestor-password-changes.show', $requestorPasswordChange->id ) }}" class="btn btn-xs btn-secondary">View</a>
                        </td>
                    </tr>
                @endforeach
            </tbody>
