<x-admin-layout title="">
    ...
    <form method="get" accept-charset="utf-8" id="searchform" action="{{ route('admin.requestorroles.index') }}">
        ...
        <div class="row">
            ...
            <div class="col-6 col-md-4 col-lg-3 col-xl-2 pt-2">
                ...
                <a href="{{ route('admin.requestorroles.index') }}" class="btn btn-sm btn-secondary">Reset</a>
            </div>
        ...
        <table class="table table-sm table-hover table-bordered w-auto">
            <thead>
                <tr>
                    ...
                    <th><a href="{{ Request::fullUrlWithQuery(['sort_field' => 'active_in_order', 'sort_direction' => $sort_direction]) }}">Active in Order</a></th>
                    <th><a href="{{ Request::fullUrlWithQuery(['sort_field' => 'active_in_search', 'sort_direction' => $sort_direction]) }}">Active in Search</a></th>
            ...
            <tbody>
                @foreach ($requestorroles as $requestorrole)
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('admin.requestorroles.show', $requestorrole->id ) }}" class="btn btn-xs btn-secondary">View</a>
                            <a href="{{ route('admin.requestorroles.edit', $requestorrole->id ) }}" class="btn btn-xs btn-secondary">Edit</a>
                        </td>
                    </tr>
                @endforeach
            </tbody>
    ...
    @if ($adminsession['contractor']['accesslevel'])
        <a href="{{ route('admin.requestorroles.create') }}" class="btn btn-sm btn-secondary">Add</a>
    @endif
