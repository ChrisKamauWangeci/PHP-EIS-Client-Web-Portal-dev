<x-admin-layout title="">
    ...
    <form method="get"
          ...
          id="searchform"
          action="{{ route('admin.smartaccessthemes.index') }}">
        <div class="row">
                ...
                <tr>
                    <th><a
                           href="{{ Request::fullUrlWithQuery(['sort_field' => 'company_name', 'sort_direction' => $sort_direction]) }}">Company
                            Name</a></th>
                    <th><a
                           href="{{ Request::fullUrlWithQuery(['sort_field' => 'smartaccess_active', 'sort_direction' => $sort_direction]) }}">Enabled</a>
                    </th>
                    <th><a
                           href="{{ Request::fullUrlWithQuery(['sort_field' => 'slug', 'sort_direction' => $sort_direction]) }}">Slug</a>
                    </th>
                    <th><a
                           href="{{ Request::fullUrlWithQuery(['sort_field' => 'backgroundcolor', 'sort_direction' => $sort_direction]) }}">Background</a>
                    </th>
                    <th><a
                           href="{{ Request::fullUrlWithQuery(['sort_field' => 'headercolor', 'sort_direction' => $sort_direction]) }}">Header</a>
                    </th>
                    <th><a
                           href="{{ Request::fullUrlWithQuery(['sort_field' => 'fontcolor', 'sort_direction' => $sort_direction]) }}">Font</a>
                    </th>
                    <th><a
            ...
            <tbody>
                @foreach ($smartaccessthemes as $smartaccesstheme)
                    <tr>
                        ...
                        <td><img src="/img/icon_{{ $smartaccesstheme->smartaccess_active ?? 0 }}.png"
                                 alt=""></td>
                        ...
                        <td>
                            <a href="{{ route('admin.smartaccessthemes.show', $smartaccesstheme->id) }}"
    ...
    <a href="{{ route('admin.smartaccessthemes.create') }}"
       class="btn btn-sm btn-secondary">Add</a>

    <br />
    <br />

    <div hx-get="{{ route('admin.smartaccessthemes.create') }}"
         hx-swap="outerHTML"
