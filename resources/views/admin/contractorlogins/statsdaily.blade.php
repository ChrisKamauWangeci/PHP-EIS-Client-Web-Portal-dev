<x-admin-layout title="">
    ...
    <form method="get" accept-charset="utf-8" id="searchform" action="{{ route('admin.contractorlogins.statsdaily') }}">
        ...
        <div class="row">
            ...
            <div class="col-6 col-md-4 col-lg-3 col-xl-2 pt-2">
                ...
                <a href="{{ route('admin.contractorlogins.statsdaily') }}" class="btn btn-sm btn-secondary">Reset</a>
            </div>
        ...
        <table class="tablesort table table-hover table-bordered table-sm table-hover w-auto">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><a href="{{ route('admin.contractorlogins.index', ['contractor' => $contractorlogin->contractor, 'from' => $contractorlogin->login_date, 'to' => $contractorlogin->login_date]) }}">{{ $contractorlogin->login_count }}</a></td>
                    <td>{{ $contractorlogin->ip_addresses }}</td>
                    <td><a href="{{ route('admin.filetransfers.index', ['type' => 'upload', 'contractor' => $contractorlogin->contractor, 'from' => $contractorlogin->login_date, 'to' => $contractorlogin->login_date]) }}">{{ $contractorlogin->total_uploads }}</a></td>
                    <td><a href="{{ route('admin.filetransfers.index', ['type' => 'download', 'contractor' => $contractorlogin->contractor, 'from' => $contractorlogin->login_date, 'to' => $contractorlogin->login_date]) }}">{{ $contractorlogin->total_downloads }}</a></td>
