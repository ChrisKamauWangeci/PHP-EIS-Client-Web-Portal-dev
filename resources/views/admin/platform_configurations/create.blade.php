    ...
    @fragment('formstore')
        <div class="row">
            <div class="col-sm-6">
                ...
                @if ($isHtmx)
                    <form hx-post="{{ route('admin.platform-configurations.store') }}"
                          hx-target="#validationerrors"
                          hx-swap="innerHTML">
                    @else
                        <form method="post"
                              action="{{ route('admin.platform-configurations.store') }}">
                @endif
