<x-admin-layout title="Shelter Agents">
    ...
    <form method="get"
          ...
          id="searchform"
          action="{{ route('admin.shelteragents.index') }}">
        ...
        <div class="row">
            ...
            <div class="col-6 col-md-4 col-lg-3 col-xl-2 pt-2">
                <x-form.select name="role"
                               label="Role"
                               :options="['' => 'All', 'sdl' => 'SDL', 'agent' => 'Agent']"
            ...
            <div class="col-6 col-md-4 col-lg-3 col-xl-2 pt-2">
                <x-form.input name="sdl_district_number"
                              label="SDL District"
                              :value="request('sdl_district_number')"
                              maxlength="50" />
            </div>
        ...
        <table class="table table-sm table-hover table-bordered w-auto">
            <thead>
                <tr>
                    ...
                    <th><a
                           href="{{ Request::fullUrlWithQuery(['sort_field' => 'sdl_district_number', 'sort_direction' => $sort_direction]) }}">SDL
                            District</a></th>
                    <th><a
                           href="{{ Request::fullUrlWithQuery(['sort_field' => 'agent_code', 'sort_direction' => $sort_direction]) }}">Agent
                            Code</a></th>
                    <th><a
