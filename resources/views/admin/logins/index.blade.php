<x-admin-layout title="">
    ...
    <div class="row">
        ...
        <div class="col text-end d-print-none">
            <a href="{{ route('admin.logins.stats') }}" class="btn btn-sm btn-secondary">IP Address Most Used</a>
        </div>
    </div>

    <form method="get" accept-charset="utf-8" id="searchform" action="{{ route('admin.logins.index') }}">
        ...
        <div class="row">
            ...
            <div class="col-6 col-md-4 col-lg-3 col-xl-2 pt-2">
                ...
                <a href="{{ route('admin.logins.index') }}" class="btn btn-sm btn-secondary">Reset</a>
            </div>
            ...
            <thead>
                <tr>
                    ...
                    <th>
                        ...
                        <a href="{{ Request::fullUrlWithQuery(['sort_field' => 'remote_host', 'sort_direction' => $sort_direction]) }}">IP Remote Host</a>
                    </th>
