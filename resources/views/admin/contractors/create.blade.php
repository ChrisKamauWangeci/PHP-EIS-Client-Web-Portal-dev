    ...
    <div class="row">
        <div class="col-sm-6">
            ...
            <form method="post"
                ...
                @endphp
                <x-form.select name="C_Invoice"
                               label="Invoice"
                               id="C_Invoice"
                               :options="$options"
                               :default="old('C_Invoice')" />
                <br />
