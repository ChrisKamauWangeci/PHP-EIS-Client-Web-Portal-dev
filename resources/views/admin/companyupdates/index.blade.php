<x-admin-layout title="">
    ...
    <form method="get" accept-charset="utf-8" id="searchform" action="{{ route('admin.companyupdates.index') }}">
        ...
        <div class="row">
            ...
            <div class="col-6 col-md-4 col-lg-3 col-xl-2 pt-2">
                ...
                <a href="{{ route('admin.companyupdates.index') }}" class="btn btn-sm btn-secondary">Reset</a>
            </div>
            ...
            <tbody>
                @foreach ($companyupdates as $companyupdate)
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('admin.companyupdates.show', $companyupdate->id ) }}" class="btn btn-xs btn-secondary">View</a>
                        </td>
                    </tr>
                @endforeach
            </tbody>
    ...
    <a href="{{ route('admin.companyupdates.create') }}" class="btn btn-sm btn-secondary">Add</a>

    <br />
    <br />

    <a href="{{ route('admin.contractors.resetcompanyupdates') }}" class="btn btn-sm btn-warning">Set Contractor News</a>
