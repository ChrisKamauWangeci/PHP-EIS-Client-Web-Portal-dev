<x-admin-layout title="">
    ...
    <form method="get" accept-charset="utf-8" action="{{ route('admin.contractorloginattempts.index') }}">
        <div class="row">
            ...
            <div class="col-6 col-md-4 col-lg-3 col-xl-2 pt-2">
                ...
                <a href="{{ route('admin.contractorloginattempts.index') }}" class="btn btn-sm btn-secondary">Reset</a>
            </div>
        </div>
    </form>
        ...
        <table class="table table-hover table-bordered table-sm table-hover w-auto">
            <thead>
                <tr>
                    ...
                    <th><a href="{{ Request::fullUrlWithQuery(['sort_field' => 'ip_address', 'sort_direction' => $sort_direction]) }}">ip_address</a></th>
                    <th><a href="{{ Request::fullUrlWithQuery(['sort_field' => 'remote_host', 'sort_direction' => $sort_direction]) }}">remote_host</a></th>
                ...
                @foreach ($contractorloginattempts as $contractorloginattempt)
                    <tr>
                        ...
                        <td>
                            ...
                            <br />
                            <img src="/img/flags/gif/{{ strtolower($contractorloginattempt->country_code ?? '') }}.gif" alt="">
                            &nbsp;
