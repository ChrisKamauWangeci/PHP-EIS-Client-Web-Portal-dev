<x-admin-layout title="">
    ...
    <form method="GET"
          action="{{ route('admin.filetransfers.index') }}">
        ...
        <div class="row">
            ...
            <div class="col-6 col-md-4 col-lg-3 col-xl-2 pt-2">
                <x-form.input name="file_type"
                              label="File Type"
                              :value="request('file_type')"
                              autocomplete="off" />
            </div>
            ...
            <div class="col-6 col-md-4 col-lg-3 col-xl-2 pt-2">
                ...
                <button class="btn btn-sm btn-secondary"
                        type="submit">Search</button> <a href="{{ route('admin.filetransfers.index') }}"
                ...
                <tr>
                    <th><a
                           href="{{ Request::fullUrlWithQuery(['sort_field' => 'workorder_id', 'sort_direction' => $sort_direction]) }}">Workorder
                            ID</a></th>
                    <th><a
                           href="{{ Request::fullUrlWithQuery(['sort_field' => 'direction', 'sort_direction' => $sort_direction]) }}">Direction</a>
                    </th>
                    <th><a
            ...
            <tbody>
                @foreach ($filetransfers as $filetransfer)
                    <tr>
                        ...
                        <td class="actions">
                            <a href="{{ route('admin.filetransfers.show', $filetransfer->id) }}"
