<x-admin-layout title="">
    ...
    <form method="get" accept-charset="utf-8" id="searchform" action="{{ route('admin.docusigndocuments.index') }}">
        ...
        <div class="row">
            ...
            <div class="col-6 col-md-4 col-lg-3 col-xl-2 pt-2">
                <x-form.input name="db" label="DB" :value="request('db')" autocomplete="off" />
            </div>
            ...
            <div class="col-6 col-md-4 col-lg-3 col-xl-2 pt-2">
                ...
                <a href="{{ route('admin.docusigndocuments.index') }}" class="btn btn-sm btn-secondary">Reset</a>
            </div>
        ...
        <table class="table table-sm table-hover table-bordered w-auto">
            <thead>
                <tr>
                    ...
                    <th><a href="{{ Request::fullUrlWithQuery(['sort_field' => 'workorder_id', 'sort_direction' => $sort_direction]) }}">Work Order ID</a></th>
            ...
            <tbody>
                @foreach ($docusigndocuments as $docusigndocument)
                    <tr>
                        ...
                        <td class="actions">
                            <a href="{{ route('admin.docusigndocuments.show', $docusigndocument->id) }}" class="btn btn-xs btn-secondary">view</a>
                        </td>
                    </tr>
                @endforeach
            </tbody>
    ...
    <a href="{{ route('admin.docusigndocuments.stats') }}" class="btn btn-sm btn-secondary">Stats</a>
