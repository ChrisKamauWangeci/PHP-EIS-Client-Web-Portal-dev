<x-admin-layout title="">
    ...
    <form method="get" accept-charset="utf-8" id="searchform" action="{{ route('admin.passwordresets.index') }}">
        ...
        <div class="row">
            ...
            <div class="col-6 col-md-4 col-lg-3 col-xl-2 pt-2">
                ...
                <a href="{{ route('admin.passwordresets.index') }}" class="btn btn-sm btn-secondary">Reset</a>
            </div>
