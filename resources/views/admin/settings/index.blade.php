<x-admin-layout title="">
        ...
        <table class="table table-sm table-hover1 table-bordered w-auto">
            <thead>
                <tr>
                    ...
                    <th><a
                           href="{{ Request::fullUrlWithQuery(['sort_field' => 'category', 'sort_direction' => $sort_direction]) }}">Category</a>
                    </th>
                    <th><a
                           href="{{ Request::fullUrlWithQuery(['sort_field' => 'name', 'sort_direction' => $sort_direction]) }}">Name</a>
                    </th>
                    <th><a
                           href="{{ Request::fullUrlWithQuery(['sort_field' => 'value', 'sort_direction' => $sort_direction]) }}">Value</a>
                    </th>
                    <th><a
    ...
    <div hx-get="{{ route('admin.settings.create') }}"
         hx-swap="outerHTML"
