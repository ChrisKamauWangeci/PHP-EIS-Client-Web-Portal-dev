<x-user-layout title="">
    ...
    <form method="get" accept-charset="utf-8" id="searchform" action="{{ route('user.workordernotices.index') }}">
        ...
        <div class="row">
            ...
            <div class="col-4 col-md-2 col-lg-2 pt-2">
                ...
                <a href="{{ route('user.workordernotices.index') }}" class="btn btn-sm btn-secondary">Reset</a>
            </div>
        ...
        <table class="table table-sm table-hover table-bordered w-auto">
            ...
            <tbody>
                @foreach ($workordernotices as $workordernotice)
                    <tr>
                        <td><a href="{{ route('user.workorders.show', $workordernotice->workorder_id) }}">{{ $workordernotice->workorder_id }}</a></td>
                        ...
                        <td><a href="{{ route('user.workordernotices.show', $workordernotice->id) }}" class="btn btn-xs btn-secondary">View</a></td>
                    </tr>
                @endforeach
            </tbody>
        </table>
