<x-user-layout title="">
    ...
    <div class="row">
        <div class="col-10 col-sm-8 col-md-6 col-lg-5 col-xl-4">
            ...
            <form method="post" action="{{ route('user.workorders.cancelupdate', $workorder->W_WorkOrder) }}" id="">
                @method('PATCH')
                @csrf

                <x-form.select name="reason" id="reason" label="Cancellation Reason" :options="$cancelreasons" empty="-" :default="old('reason')" required />
                <br />
