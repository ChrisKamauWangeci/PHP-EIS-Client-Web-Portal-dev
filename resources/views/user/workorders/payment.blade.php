<x-user-layout title="">
    ...
    <div class="row">
        <div class="col-sm-6">
            <form method="post"
                  action="{{ route('user.workorders.paymentupdate', $workorder->W_WorkOrder) }}"
                  id="">
                @csrf
                @method('PATCH')
                ...
                <div class="cc">
                    ...
                    <x-form.select name="CC_No"
                                   label="Card Number"
                                   id="card_number"
                                   :options="$creditcardinfoslists"
                                   empty="-" />
                ...
                @if ($dr == 1)
                    ...
                    @else
                        ...
                        <input type="hidden"
                               name="W_DrFee1"
                               value="{{ $workorder->W_DrFee1 }}">
                        <br />
                    @endif

                    <br />
                    <div class="check">
                        <x-form.input name="payable"
                                      label="Payable To"
                                      :value="old('payable', $workorder->W_Hospital)"
                                      required />
                        <br />
                    </div>
                    <x-form.input name="W_DrCheckNo"
                                  label="Check / Card Info"
                                  :value="old('W_DrCheckNo', $workorder->W_DrCheckNo)"
                                  maxlength="15" />
                    <br />
                    <x-form.input name="W_DrCheckDate"
                                  label="Check / Card Date"
                ...
                @elseif ($dr == 2)
                    ...
                    <x-form.input name="W_DrCheckNo2"
                                  label="Check / Card Info"
                                  :value="old('W_DrCheckNo2')"
                                  maxlength="15" />
                    <br />
                    <x-form.input name="W_DrCheckDate2"
                                  label="Check / Card Date"
                                  :value="old('W_DrCheckDate2')"
                                  type="date"
                                  autocomplete="off"
                                  min="{{ date('Y-m-d', strtotime('-1 year')) }}"
                                  max="{{ date('Y-m-d', strtotime('+1 year')) }}" />
                ...
                <div class="check">
                    ...
                    @endphp
                    <x-form.select name="sendmethod"
                                   label="Check Send Method"
                                   id="sendmethod"
                                   :options="$options" />
                    <br />

                    <x-form.input name="mailing_address"
                ...
                <div id="custodianblock">
                    <x-form.input name="custodian"
                                  label="Custodian Name"
                                  :value="old('custodian')" />
                    <br />
                    <x-form.input type="phone"
                                  name="custodian_phone"
                                  label="Custodian Phone"
                                  :value="old('custodian_phone')" />
                </div>
