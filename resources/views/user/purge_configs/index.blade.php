<x-user-layout title="">
    ...
    <form method="get"
          ...
          id="searchform"
          action="{{ route('user.purge_configs.index') }}">
                ...
                <tr>
                    <th><a
                           href="{{ Request::fullUrlWithQuery(['sort_field' => 'company_name', 'sort_direction' => $sort_direction]) }}">Company
                            Name</a></th>
                    <th><a
                           href="{{ Request::fullUrlWithQuery(['sort_field' => 'folder_name', 'sort_direction' => $sort_direction]) }}">Folder
                            Name</a></th>
                    <th>
                        Source Path
                        <br />
                    ...
                    <th><a
                           href="{{ Request::fullUrlWithQuery(['sort_field' => 'frequency', 'sort_direction' => $sort_direction]) }}">Frequency</a>
                    </th>
                    <th><a
                           href="{{ Request::fullUrlWithQuery(['sort_field' => 'purge_after_days', 'sort_direction' => $sort_direction]) }}">Purge
                            After Days</a></th>
                    <th><a
                           href="{{ Request::fullUrlWithQuery(['sort_field' => 'purge_type', 'sort_direction' => $sort_direction]) }}">Purge
                            Type</a></th>
                    <th><a
                           href="{{ Request::fullUrlWithQuery(['sort_field' => 'last_purge_date', 'sort_direction' => $sort_direction]) }}">Last
                            Purge Date</a></th>
                    <th><a
    ...
    <a href="{{ route('user.purge_configs.create') }}"
