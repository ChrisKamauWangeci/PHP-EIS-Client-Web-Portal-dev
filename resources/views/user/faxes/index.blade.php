<x-user-layout title="">
    ...
    <form method="GET"
        ...
        <div class="row">
            ...
            <div class="col-4 col-md-2 col-lg-2 pt-2">
                <x-form.input name="fax_number"
                              id="fax_number"
                              label="Fax Number"
                              :value="request('fax_number')" />
            </div>
            ...
            <div class="col-4 col-md-2 col-lg-2 pt-2">
                <x-form.input name="api_status"
                              id="api_status"
                              label="API Status"
                              :value="request('api_status')" />
            </div>
        ...
        <table class="table table-sm table-hover table-bordered w-auto">
            <thead>
                <tr>
                    ...
                    <th><a
                           href="{{ Request::fullUrlWithQuery(['sort_field' => 'fax_number', 'sort_direction' => $sort_direction]) }}">Fax
                            Number</a></th>
                    <th><a
                           href="{{ Request::fullUrlWithQuery(['sort_field' => 'email', 'sort_direction' => $sort_direction]) }}">Email</a>
                    </th>
                    <th><a
                           href="{{ Request::fullUrlWithQuery(['sort_field' => 'file', 'sort_direction' => $sort_direction]) }}">File</a>
                    </th>
                    <th><a
                           href="{{ Request::fullUrlWithQuery(['sort_field' => 'api_status', 'sort_direction' => $sort_direction]) }}">API
                            Status</a></th>
                    <th><a
