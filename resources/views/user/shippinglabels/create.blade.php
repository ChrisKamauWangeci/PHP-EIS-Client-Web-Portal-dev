<x-user-layout title="">
    ...
    <div class="row">
        <div class="col-auto">
            <h1>Shipping Labels, Workorder: {{ $workorder->W_WorkOrder }} - {{ $workorder->W_FirstName }} {{ $workorder->W_LastName }}</h1>
        </div>
    ...
    <div class="row">
        <div class="col-sm-8 col-md-5">
            ...
            <form method="post" action="{{ route('user.shippinglabels.store') }}" enctype="multipart/form-data">
                @csrf
                ...
                <x-form.select name="label" label="Label" :options="$options" empty=" " required />
                <br />

                <x-form.input type="text" name="W_Tracking" label="Tracking Number" required />
                <br />

                <x-form.input type="file" name="shipping_label" label="Shipping Label" accept="application/pdf" required />
                <br />
