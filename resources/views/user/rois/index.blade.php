        ...
        <div class="row">
            ...
            <div class="col-4 col-md-2 col-lg-2 pt-2">
                <x-form.input name="R_ROIname"
                              label="ROI Name"
                              :value="request('R_ROIname')" />
            </div>

            <div class="col-4 col-md-2 col-lg-2 pt-2">
                <x-form.input name="R_City"
                              label="City"
                              :value="request('R_City')" />
            </div>

            <div class="col-4 col-md-2 col-lg-2 pt-2">
                <x-form.select name="R_State"
                               label="State"
                               :options="Helper::states()"
                               empty="-"
                               :default="request('R_State')" />
            </div>
    ...
    <div class="table-responsive">
        <table class="table table-sm table-hover table-bordered w-auto">
            <thead>
                <tr>
                    <th><a
                           href="{{ Request::fullUrlWithQuery(['sort_field' => 'R_ROIname', 'sort_direction' => $sort_direction]) }}">ROI
                            Name</a></th>
                    <th>
                        Address /
                        City /
                        ...
                        <td>
                            @if ($postname)
                                <button class="btn btn-xs btn-success"
                                        onclick="post_value('{{ $roi->R_ROIname }}');">Select</button>
                            @endif
