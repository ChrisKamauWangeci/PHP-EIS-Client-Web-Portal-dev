<x-user-layout title="">
    ...
    <form method="get"
          ...
          id="searchform"
          action="{{ route('user.ehrorders.index') }}">
        <div class="row">
            ...
            <div class="col-6 col-sm-4 col-md-3 col-lg-2 pt-2">
                <x-form.input type="date"
                              name="submitted_at_from"
                              id="submitted_at_from"
                              label="Submitted At (From)"
                              :value="request('submitted_at_from')" />
            </div>
            <div class="col-6 col-sm-4 col-md-3 col-lg-2 pt-2">
                <x-form.input type="date"
                              name="submitted_at_to"
                              id="submitted_at_to"
                              label="Submitted At (To)"
                              :value="request('submitted_at_to')" />
            </div>
            <div class="col-6 col-sm-4 col-md-3 col-lg-2 pt-2">
                <x-form.input type="date"
                ...
                <tr>
                    ...
                    <th><a
                           href="{{ Request::fullUrlWithQuery(['sort_field' => 'workorder_id', 'sort_direction' => $sort_direction]) }}">Workorder
                            ID</a></th>
                    <th><a href="{{ Request::fullUrlWithQuery(['sort_field' => 'service_provider', 'sort_direction' => $sort_direction]) }}"
                           title="Service Provider">SP</a></th>
                    <th><a href="{{ Request::fullUrlWithQuery(['sort_field' => 'company_name', 'sort_direction' => $sort_direction]) }}"
                           title="Company">Company</a></th>
                    <th><a
                    ...
                    <th><a
                           href="{{ Request::fullUrlWithQuery(['sort_field' => 'last_name', 'sort_direction' => $sort_direction]) }}">Last
                            Name</a></th>
                    <th><a
                           href="{{ Request::fullUrlWithQuery(['sort_field' => 'gender', 'sort_direction' => $sort_direction]) }}">G</a>
                    </th>
                    <th><a
                           href="{{ Request::fullUrlWithQuery(['sort_field' => 'birth_date', 'sort_direction' => $sort_direction]) }}">Birth
                            Date</a></th>
                    <th><a
                           href="{{ Request::fullUrlWithQuery(['sort_field' => 'state', 'sort_direction' => $sort_direction]) }}">State</a>
                    </th>
                    <th><a
                           href="{{ Request::fullUrlWithQuery(['sort_field' => 'submission_type', 'sort_direction' => $sort_direction]) }}">Submission
                            Type</a></th>
                    <th><a
                                    ...
                                    <tbody>
                                        @foreach ($ehrorder->ehrorderssearchresults as $ehrorderssearchresult)
                                            @if ($ehrorderssearchresult->managing_organization)
                                                @include('user.ehrorderssearchresults._status_button', [
                                                    'ehrorderssearchresult' => $ehrorderssearchresult,
                                                ])
                                            @endif
                                        @endforeach
                                    </tbody>
    ...
    <a href="{{ route('user.ehrorders.create') }}"
