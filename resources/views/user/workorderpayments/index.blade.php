<x-user-layout title="">
    ...
    <form method="GET"
          action="{{ route('user.workorderpayments.index') }}">
                ...
                <tr>
                    <th><a
                           href="{{ Request::fullUrlWithQuery(['sort_field' => 'workorder_id', 'sort_direction' => $sort_direction]) }}">Workorder
                            ID</a></th>
                    <th><a
                           href="{{ Request::fullUrlWithQuery(['sort_field' => 'payment_type', 'sort_direction' => $sort_direction]) }}">Payment
                            Type</a></th>
                    <th><a
                           href="{{ Request::fullUrlWithQuery(['sort_field' => 'amount', 'sort_direction' => $sort_direction]) }}">Amount</a>
                    </th>
                    <th><a
                           href="{{ Request::fullUrlWithQuery(['sort_field' => 'recipient', 'sort_direction' => $sort_direction]) }}">Recipient</a>
                    </th>
                    <th><a
                           href="{{ Request::fullUrlWithQuery(['sort_field' => 'payment_date', 'sort_direction' => $sort_direction]) }}">Payment
                            Date</a></th>
                    <th><a
                           href="{{ Request::fullUrlWithQuery(['sort_field' => 'check_number', 'sort_direction' => $sort_direction]) }}">Check
                            Number</a></th>
                    <th><a
            ...
            <tbody>
                @foreach ($workorderpayments as $workorderpayment)
                    <tr>
                        ...
                        <td><a href="{{ route('user.workorderpayments.show', $workorderpayment->id) }}"
    ...
    @if (request('workorder_id'))
        <a href="{{ route('user.workorderpayments.create', ['workorder_id' => request('workorder_id')]) }}"
