<x-user-layout title="">
    ...
    <div class="col-md-5">
        ...
        <form method="get"
              action="{{ route('user.signforms.create') }}">
            <input type="hidden"
                   name="path"
                   value="{{ $subdomain }}">
            <input type="hidden"
            ...
            <input type="hidden"
                   name="client"
                   value="{{ $workorder->Requestor_R_Company }}">
            ...
            <input type="hidden"
                   name="eis_address"
                   value="P.O. Box 778 Torrance CA 90508"
                   class="form-control form-control-sm">
            <!-- <br /> -->
            ...
            <input type="hidden"
                   ...
                   value="{!! $workorder->W_FirstName !!} {!! $workorder->W_MiddleInit !!} {!! $workorder->W_LastName !!}"
                   class="form-control form-control-sm">
            <!-- <br /> -->
            ...
            <input type="hidden"
                   ...
                   value="{{ substr($workorder->W_DOB ?? '', 0, 10) }}"
                   class="form-control form-control-sm">
            <!-- <br /> -->
            ...
            <input type="hidden"
                   ...
                   value="{{ date('m/d/Y', strtotime($workorder->W_DOB ?? '')) }}"
                   class="form-control form-control-sm">
            <!-- <br /> -->
            ...
            @php
                $patientSocialSecurity =
                    ($workorder->Requestor_R_Company ?? '') === 'MAGNA SERVICING LLC'
                        ? $workorder->W_SS ?? ''
                        : substr($workorder->W_SS ?? '', -4);
            @endphp

            <input type="hidden"
                   name="patient_social_security"
                   value="{{ $patientSocialSecurity }}"
                   class="form-control form-control-sm">
            <!-- <br /> -->
            ...
            <input type="hidden"
                   name="patient_email"
                   value="{{ $workorder->Examrequest_E_ApplicantEmail }}"
                   class="form-control form-control-sm">
            <!-- <br /> -->
            ...
            <input type="hidden"
                   name="W_ReceiveDate"
                   value="{{ $workorder->W_ReceiveDate->format('m/d/Y') }}"
                   class="form-control form-control-sm">
            <!-- <br /> -->
            ...
            <input type="hidden"
                   ...
                   value="{!! Helper::recordYearsFrom($workorder->W_YearsOfRecord, $workorder->W_ReceiveDate) !!}"
                   class="form-control form-control-sm">
            <!-- <br /> -->
            ...
            <!-- <br /> -->
            <input type="hidden"
                   name="dates_of_service_from_ymd"
                   value="{!! Helper::recordYearsFrom($workorder->W_YearsOfRecord, $workorder->W_ReceiveDate, null, 'Y-m-d') !!}"
                   class="form-control form-control-sm">
            <!-- <br /> -->
            ...
            <!-- <br /> -->
            <input type="hidden"
                   name="dates_of_service_to_ymd"
                   value="{!! Helper::recordYearsTo($workorder->W_YearsOfRecord, $workorder->W_ReceiveDate, null, 'Y-m-d') !!}"
                   class="form-control form-control-sm">
            <!-- <br /> -->
            ...
            <input type="hidden"
                   ...
                   value="{!! Helper::recordYearsFromTo($workorder->W_YearsOfRecord, $workorder->W_ReceiveDate) !!}"
                   class="form-control form-control-sm">
            <!-- <br /> -->
            ...
            <input type="hidden"
                   ...
                   value="{!! Helper::recordYearsFromTo($workorder->W_YearsOfRecord, $workorder->W_ReceiveDate, null, null, 'Y-m-d') !!}"
                   class="form-control form-control-sm">
            <!-- <br /> -->
            ...
            <!-- <br /> -->
            <input type="hidden"
                   name="dates_of_service_combined_present"
                   value="{!! Helper::recordYearsFrom($workorder->W_YearsOfRecord, $workorder->W_ReceiveDate) !!} - PRESENT"
                   class="form-control form-control-sm">
            <!-- <br /> -->
            ...
            <!-- <br /> -->
            <input type="hidden"
                   name="dates_of_service_combined_present_ymd"
                   value="{!! Helper::recordYearsFrom($workorder->W_YearsOfRecord, $workorder->W_ReceiveDate, null, 'Y-m-d') !!} - PRESENT"
                   class="form-control form-control-sm">
            <!-- <br /> -->
            ...
            <input type="hidden"
                   ...
                   value="{{ now()->addYear($expirationYears)->format('m/d/Y') }}"
                   class="form-control form-control-sm">
            <!-- <br /> -->
            ...
            <!-- <br /> -->
            <input type="hidden"
                   name="expiration_date_ymd"
                   value="{{ now()->addYear($expirationYears)->toDateString() }}"
                   class="form-control form-control-sm">
            <!-- <br /> -->
            ...
            <button type="submit"
                    class="btn btn-sm btn-primary">In-house Prefill</button>
        </form>
