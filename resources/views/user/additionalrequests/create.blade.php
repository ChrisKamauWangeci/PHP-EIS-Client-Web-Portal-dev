<x-user-layout title="">
    ...
    <div class="row">
        <div class="col-auto">
            <h1>Additional Requests File Submission: {{ $workorder->W_WorkOrder }} - {{ $workorder->W_FirstName }} {{ $workorder->W_LastName }}</h1>
        </div>
    ...
    <div class="row">
        ...
        <div class="col-6">
            ...
            <form method="post" action="{{ route('user.additionalrequests.store') }}">
                @csrf
                ...
                @endphp
                <x-form.select name="requesttype" label="Request Type" id="requesttype" :options="$options" empty="-" :default="old('requesttype')" onchange="setTextArea(this)" required />

                <br />

                <x-form.select name="lor" label="LOR Type" id="lor" :options="$loroptions" empty="-" :default="old('lor')" />

                <br />

                <x-form.textarea name="message" label="Message" id="message" :rows="8" minlength="5" maxlength="1000" required />
