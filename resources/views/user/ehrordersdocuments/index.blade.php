<x-user-layout title="">
    ...
    <form method="get" accept-charset="utf-8" id="searchform" action="{{ route('user.ehrordersdocuments.index') }}">

        <div class="row">

            <div class="col-6 col-sm-4 col-md-3 col-lg-2 pt-2">
                <x-form.input name="id" id="id" label="EHR Order Document ID" :value="request('id')" />
            </div>
            ...
            <div class="col-6 col-sm-4 col-md-3 col-lg-2 pt-2">
                <x-form.input type="datetime-local" name="received_at_from" label="Received At (From)" :value="request('received_at_from')" />
            </div>

            <div class="col-6 col-sm-4 col-md-3 col-lg-2 pt-2">
                <x-form.input type="datetime-local" name="received_at_to" label="Received At (To)" :value="request('received_at_to')" />
            </div>

            <div class="col-6 col-sm-4 col-md-3 col-lg-2 pt-2">
                <x-form.input type="datetime-local" name="created_at_from" label="Created At (From)" :value="request('created_at_from')" />
            </div>

            <div class="col-6 col-sm-4 col-md-3 col-lg-2 pt-2">
                <x-form.input type="datetime-local" name="created_at_to" label="Created At (To)" :value="request('created_at_to')" />
            </div>

            <div class="col-6 col-sm-4 col-md-3 col-lg-2 pt-2">
                <br />
                <x-form.button>Submit</x-form.button>
                <a href="{{ route('user.ehrordersdocuments.index') }}" class="btn btn-sm btn-secondary">Reset</a>
            </div>
        </div>
        ...
        <table class="table table-sm table-hover table-bordered w-auto">
            <thead>
                <tr>
                    ...
                    <th><a href="{{ Request::fullUrlWithQuery(['sort_field' => 'ehrorderssearchresult_id', 'sort_direction' => $sort_direction]) }}">EHR Order Search Result ID</a></th>
                    <th><a href="{{ Request::fullUrlWithQuery(['sort_field' => 'workorder_id', 'sort_direction' => $sort_direction]) }}">Workorder ID</a></th>
                    <th><a href="{{ Request::fullUrlWithQuery(['sort_field' => 'service_provider', 'sort_direction' => $sort_direction]) }}">Service Provider</a></th>
                    <th>
                    ...
                    <th><a href="{{ Request::fullUrlWithQuery(['sort_field' => 'event_date', 'sort_direction' => $sort_direction]) }}">Event Date</a></th>
                    <th><a href="{{ Request::fullUrlWithQuery(['sort_field' => 'file_type', 'sort_direction' => $sort_direction]) }}">File Type</a></th>
                    <th><a href="{{ Request::fullUrlWithQuery(['sort_field' => 'file_size', 'sort_direction' => $sort_direction]) }}">File Size</a></th>
                    <th><a href="{{ Request::fullUrlWithQuery(['sort_field' => 'download_duration', 'sort_direction' => $sort_direction]) }}">Download Duration</a></th>
                    <th><a href="{{ Request::fullUrlWithQuery(['sort_field' => 'retry_count', 'sort_direction' => $sort_direction]) }}">Retry Count</a></th>
                    <th><a href="{{ Request::fullUrlWithQuery(['sort_field' => 'status', 'sort_direction' => $sort_direction]) }}">Status</a></th>
                    <th><a href="{{ Request::fullUrlWithQuery(['sort_field' => 'processing_at', 'sort_direction' => $sort_direction]) }}">Processing At</a></th>
            ...
            <tbody>
                @foreach ($ehrordersdocuments as $ehrordersdocument)
                    <tr>
                        ...
                        <td><a href="{{ route('user.ehrorders.show', $ehrordersdocument->ehrorder_id) }}">{{ $ehrordersdocument->ehrorder_id }}</a></td>
                        <td><a href="{{ route('user.ehrorderssearchresults.show', $ehrordersdocument->ehrorderssearchresult_id) }}">{{ $ehrordersdocument->ehrorderssearchresult_id }}</a></td>
