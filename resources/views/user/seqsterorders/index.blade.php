<x-user-layout title="">
    ...
    <form method="get"
          ...
          id="searchform"
          action="{{ route('user.seqsterorders.index') }}">

        <div class="row">

            <div class="col-6 col-md-4 col-lg-3 col-xl-2 pt-2">
                <x-form.input name="project_title"
                              label="Project Title"
        ...
        <table class="table table-sm table-hover table-bordered w-auto">
            <thead>
                <tr>
                    ...
                    <th>
                        <a
                           href="{{ Request::fullUrlWithQuery(['sort_field' => 'project_title', 'sort_direction' => $sort_direction]) }}">Project
                            Title</a>
                        <a
                           href="{{ Request::fullUrlWithQuery(['sort_field' => 'site_name', 'sort_direction' => $sort_direction]) }}">Site
                            Name</a>
                    </th>
                    <th>
                        <a
                           href="{{ Request::fullUrlWithQuery(['sort_field' => 'workorder_id', 'sort_direction' => $sort_direction]) }}">Workorder
                            ID</a>
                        <a
                           href="{{ Request::fullUrlWithQuery(['sort_field' => 'patient_id', 'sort_direction' => $sort_direction]) }}">Patient
                            ID</a>
                    </th>
                    <th><a
                    ...
                    <th>
                        ...
                        <br />
                        <a
                           href="{{ Request::fullUrlWithQuery(['sort_field' => 'gender', 'sort_direction' => $sort_direction]) }}">Gender</a>
                        <br />
                        <a
                           href="{{ Request::fullUrlWithQuery(['sort_field' => 'birthday', 'sort_direction' => $sort_direction]) }}">Birthday</a>
                    </th>
                    <th>
                        <a
                           href="{{ Request::fullUrlWithQuery(['sort_field' => 'address_1', 'sort_direction' => $sort_direction]) }}">Address
                            1</a>
                        <br />
                        <a
                        ...
                        <br />
                        <a
                           href="{{ Request::fullUrlWithQuery(['sort_field' => 'state', 'sort_direction' => $sort_direction]) }}">State</a>
                        <br />
                        <a
                           href="{{ Request::fullUrlWithQuery(['sort_field' => 'postal_code', 'sort_direction' => $sort_direction]) }}">Postal
                            Code</a>
                    </th>
                    <th>
                        <a
                        ...
                        <br />
                        <a
                           href="{{ Request::fullUrlWithQuery(['sort_field' => 'statusapi', 'sort_direction' => $sort_direction]) }}">Status
                            API</a>
                    </th>
                    <th>
                        <a
                           href="{{ Request::fullUrlWithQuery(['sort_field' => 'seqster_at', 'sort_direction' => $sort_direction]) }}">Seqster
                            At</a>
                        <br />
                        <a
                        ...
                        <br />
                        <a
                           href="{{ Request::fullUrlWithQuery(['sort_field' => 'reminded_at', 'sort_direction' => $sort_direction]) }}">Reminded
                            At</a>
                        <br />
                        <a
                           href="{{ Request::fullUrlWithQuery(['sort_field' => 'email_viewed_count', 'sort_direction' => $sort_direction]) }}">Email
                            Viewed Count</a>
                    </th>
                    <th>
                        <a
                           href="{{ Request::fullUrlWithQuery(['sort_field' => 'visited_at', 'sort_direction' => $sort_direction]) }}">Visited
                            At</a>
                        <a
                           href="{{ Request::fullUrlWithQuery(['sort_field' => 'visit_count', 'sort_direction' => $sort_direction]) }}">Visit
                            Count</a>
                    </th>
                    <th>
                        <a
            ...
            <tbody>
                @foreach ($seqsterorders as $seqsterorder)
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('user.seqsterorders.show', $seqsterorder->id) }}"
    ...
    <a href="{{ route('user.seqsterorders.stats') }}"
