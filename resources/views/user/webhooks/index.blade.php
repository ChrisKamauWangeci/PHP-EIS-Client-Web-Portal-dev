<x-user-layout title="">
    ...
    <form method="get" accept-charset="utf-8" id="searchform" action="{{ route('user.webhooks.index') }}">
        <div class="row">
            <div class="col-6 col-sm-4 col-md-3 col-lg-2 pt-2">
                <x-form.input name="id" id="id" label="ID" :value="request('id')" />
            </div>
            <div class="col-6 col-sm-4 col-md-3 col-lg-2 pt-2">
                <x-form.input name="payload" id="payload" label="Payload" :value="request('payload')" />
            </div>
            <div class="col-6 col-sm-4 col-md-3 col-lg-2 pt-2">
            ...
            <div class="col-6 col-sm-4 col-md-3 col-lg-2 pt-2">
                ...
                <a href="{{ route('user.webhooks.index') }}" class="btn btn-sm btn-secondary">Reset</a>
            </div>
        </div>
    </form>
        ...
        <table class="table table-sm table-hover1 table-bordered w-auto">
            <thead>
                <tr>
                    ...
                    <th><a href="{{ Request::fullUrlWithQuery(['sort_field' => 'payload', 'sort_direction' => $sort_direction]) }}">Payload</a></th>
            ...
            <tbody>
                @foreach ($webhooks as $webhook)
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('user.webhooks.show', $webhook->id) }}" class="btn btn-xs btn-secondary">View</a>
                        </td>
                    </tr>
                @endforeach
            </tbody>
