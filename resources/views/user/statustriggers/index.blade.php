<x-user-layout title="">
    ...
    <form method="get"
          ...
          id="searchform"
          action="{{ route('user.statustriggers.index') }}">
            ...
            <tbody>
                @foreach ($statustriggers as $statustrigger)
                    <tr>
                        ...
                        <td>
                            <a
                               href="{{ route('user.workorders.show', $statustrigger->WorkOrderNo) }}">{{ $statustrigger->WorkOrderNo }}</a>
                        </td>
                        ...
                        <td>
                            <a href="{{ route('user.statustriggers.show', $statustrigger->ID) }}"
