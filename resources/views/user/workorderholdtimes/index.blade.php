<x-user-layout title="Workorder Hold Times">
    ...
    <form method="GET"
          action="{{ route('user.workorderholdtimes.index') }}">
        ...
        <div class="row">
            ...
            <div class="col-6 col-md-3 col-lg-2 pt-2">
                <x-form.select name="reason"
                               ...
                               :options="array_combine(Helper::reasons(), Helper::reasons())"
                               autocomplete="off" />
            </div>

            <div class="col-6 col-md-3 col-lg-2 pt-2">
                <x-form.input name="date_start_from"
                              id="date_start_from"
                              label="Date Start From"
                              :value="request('date_start_from')"
                              type="date"
                              autocomplete="off"
                              min="2020-01-01"
                              max="2030-01-01" />
            ...
            <div class="col-6 col-md-3 col-lg-2 pt-2">
                <x-form.input name="date_start_to"
                              id="date_start_to"
                              label="Date Start To"
                              :value="request('date_start_to')"
                              type="date"
                              autocomplete="off"
                              min="2020-01-01"
                              max="2030-01-01" />
            ...
            <div class="col-6 col-md-3 col-lg-2 pt-2">
                <x-form.input name="date_end_from"
                              id="date_end_from"
                              label="Date End From"
                              :value="request('date_end_from')"
                              type="date"
                              autocomplete="off"
                              min="2020-01-01"
                              max="2030-01-01" />
            ...
            <div class="col-6 col-md-3 col-lg-2 pt-2">
                <x-form.input name="date_end_to"
                              id="date_end_to"
                              label="Date End To"
                              :value="request('date_end_to')"
                              type="date"
                              autocomplete="off"
                              min="2020-01-01"
                              max="2030-01-01" />
            ...
            <div class="col-6 col-md-3 col-lg-2 pt-2">
                ...
                @endphp
                <x-form.select name="closed"
                               label="Closed"
                               :options="$selects"
                               empty="-"
                               :default="request('closed')" />
            </div>
            ...
            <tbody>
                @foreach ($workorderholdtimes as $workorderholdtime)
                    <tr>
                        ...
                        <td>
                            <a
                               href="{{ route('user.workorders.show', $workorderholdtime->workorder_id) }}">{{ $workorderholdtime->workorder_id }}</a>
                        </td>
                        ...
                        <td>{{ (int) $workorderholdtime->date_start?->diffInDays($workorderholdtime->date_end) ?? 'N/A' }}
                        </td>
                        <td>{{ $workorderholdtime->created_by }}</td>
                        <td><a href="{{ route('user.workorderholdtimes.show', $workorderholdtime->id) }}"
