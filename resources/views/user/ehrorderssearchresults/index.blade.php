<x-user-layout title="">
    ...
    <form method="get" accept-charset="utf-8" id="searchform" action="{{ route('user.ehrorderssearchresults.index') }}">

        <div class="row">
            <div class="col-6 col-sm-4 col-md-3 col-lg-2 pt-2">
                <x-form.input name="ehrorder_id" id="ehrorder_id" label="EHR Order ID" :value="request('ehrorder_id')" />
            </div>
            <div class="col-6 col-sm-4 col-md-3 col-lg-2 pt-2">
                <x-form.input name="workorder_id" label="Workorder ID" :value="request('workorder_id')" />
            </div>
            <div class="col-6 col-sm-4 col-md-3 col-lg-2 pt-2">
                <x-form.input name="managing_organization" label="Managing Organization" :value="request('managing_organization')" />
            </div>
            <div class="col-6 col-sm-4 col-md-3 col-lg-2 pt-2">
            ...
            <div class="col-6 col-sm-4 col-md-3 col-lg-2 pt-2">
                <x-form.input name="status" label="Status" :value="request('status')" />
            </div>
            <div class="col-6 col-sm-4 col-md-3 col-lg-2 pt-2">
                <x-form.select name="consent_required" label="Consent Required" :default="request('consent_required')" :options="['all' => 'Any', 'null' => 'Not Required', 'not_null' => 'Required']" />
            </div>
            ...
            <div class="col-6 col-sm-4 col-md-3 col-lg-2 pt-2">
                <x-form.input type="date" name="received_at_from" label="Received At (From)" :value="request('received_at_from')" />
            </div>
            <div class="col-6 col-sm-4 col-md-3 col-lg-2 pt-2">
                <x-form.input type="date" name="received_at_to" label="Received At (To)" :value="request('received_at_to')" />
            </div>
            <div class="col-6 col-sm-4 col-md-3 col-lg-2 pt-2">
                <x-form.input type="date" name="created_at_from" label="Created At (From)" :value="request('created_at_from')" />
            </div>
            <div class="col-6 col-sm-4 col-md-3 col-lg-2 pt-2">
                <x-form.input type="date" name="created_at_to" label="Created At (To)" :value="request('created_at_to')" />
            </div>
            <div class="col-6 col-sm-4 col-md-3 col-lg-2 pt-2">
                <br />
                <x-form.button>Submit</x-form.button>
                <a href="{{ route('user.ehrorderssearchresults.index') }}" class="btn btn-sm btn-secondary">Reset</a>
            </div>
        </div>
    ...
    <a href="{{ route('user.ehrorderssearchresults.export', array_merge(request()->query(), ['type' => 'csv'])) }}">Export CSV</a>
    &nbsp;
    <a href="{{ route('user.ehrorderssearchresults.export', array_merge(request()->query(), ['type' => 'xlsx'])) }}">Export Excel</a>
        ...
        <table class="table table-sm table-hover table-bordered w-auto">
            <thead>
                <tr>
                    ...
                    <th><a href="{{ Request::fullUrlWithQuery(['sort_field' => 'ehrorder_id', 'sort_direction' => $sort_direction]) }}">EHR Order ID</a></th>
                    <th><a href="{{ Request::fullUrlWithQuery(['sort_field' => 'workorder_id', 'sort_direction' => $sort_direction]) }}">WO ID</a></th>
                    <th><a href="{{ Request::fullUrlWithQuery(['sort_field' => 'managing_organization', 'sort_direction' => $sort_direction]) }}">Managing Organization</a></th>
                    <th><a href="{{ Request::fullUrlWithQuery(['sort_field' => 'service_provider', 'sort_direction' => $sort_direction]) }}">SP</a></th>
                    ...
                    <th><a href="{{ Request::fullUrlWithQuery(['sort_field' => 'consent_required', 'sort_direction' => $sort_direction]) }}" title="Consent Required">CR</a></th>
                    <th><a href="{{ Request::fullUrlWithQuery(['sort_field' => 'status', 'sort_direction' => $sort_direction]) }}">Status</a></th>
                    <th>
                        <a href="{{ Request::fullUrlWithQuery(['sort_field' => 'operation_outcome', 'sort_direction' => $sort_direction]) }}">Operation Outcome</a>
                        <a href="{{ Request::fullUrlWithQuery(['sort_field' => 'operation_outcome_at', 'sort_direction' => $sort_direction]) }}">Operation Outcome At</a>
                    </th>
                    <th><a href="{{ Request::fullUrlWithQuery(['sort_field' => 'is_active', 'sort_direction' => $sort_direction]) }}">Is Active</a></th>
                    <th><a href="{{ Request::fullUrlWithQuery(['sort_field' => 'requested_at', 'sort_direction' => $sort_direction]) }}">Requested At</a></th>
                    <th><a href="{{ Request::fullUrlWithQuery(['sort_field' => 'submitted_at', 'sort_direction' => $sort_direction]) }}">Submitted At</a></th>
                    <th><a href="{{ Request::fullUrlWithQuery(['sort_field' => 'received_at', 'sort_direction' => $sort_direction]) }}">Received At</a></th>
            ...
            <tbody>
                @foreach ($ehrorderssearchresults as $ehrorderssearchresult)
                    <tr>
                        ...
                        <td><a href="{{ route('user.ehrorders.show', $ehrorderssearchresult->ehrorder_id) }}">{{ $ehrorderssearchresult->ehrorder_id }}</a></td>
                        ...
                        <td class="{{ $ehrorderssearchresult->received_at ? 'bg-success-subtle' : '' }}">{{ $ehrorderssearchresult->received_at }}</td>
