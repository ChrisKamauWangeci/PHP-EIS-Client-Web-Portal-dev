<tr id="ehrorderssearchresult-{{ $ehrorderssearchresult->id }}">
    <td>
        ...
        <form
            hx-post="/user/ehrorderssearchresults/{{ $ehrorderssearchresult->id }}/requestrecords"
    ...
    <td>
        <a href="{{ route('user.ehrorderssearchresults.show', $ehrorderssearchresult->id) }}">{{ $ehrorderssearchresult->managing_organization }}</a>
    </td>
    ...
    <td class="{{ $ehrorderssearchresult->operation_outcome ? 'bg-danger-subtle' : '' }} small">{{ $ehrorderssearchresult->operation_outcome }}</td>
</tr>