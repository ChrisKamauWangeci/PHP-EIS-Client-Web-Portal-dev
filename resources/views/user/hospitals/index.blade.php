<x-user-layout title="">
    ...
    <div class="row">
        ...
        <div class="col-6 text-end">
            <a href="{{ route('user.hospitals.create') }}"
    ...
    <form method="post"
          ...
          id="searchform"
          action="{{ route('user.hospitals.prg') }}">
        @csrf
        ...
        <div class="row">
            ...
            <div class="col-6 col-md-2 pt-2">
                <x-form.input name="H_Hospital2"
                              label="Facility / Hospital 2"
                              :value="request('H_Hospital2')"
                              type="text"
                              autocomplete="off" />
            </div>
            ...
            <div class="col-6 col-md-2 pt-2">
                <x-form.select name="H_State"
                               label="State"
                               id="H_State"
                               :options="Helper::states()"
                               empty="-"
                               :default="request('H_State')" />
            </div>
    ...
    <form method="post"
          action="{{ route('user.hospitals.transfer') }}">
        @csrf
            ...
            <table class="table table-sm table-hover table-bordered w-auto">
                <thead>
                    <tr>
                        ...
                        <th>
                            <a
                               href="{{ Request::fullUrlWithQuery(['sort_field' => 'H_Created', 'sort_direction' => $sort_direction]) }}">Created</a>
                            <br />
                            <a
                            ...
                            <br />
                            <a
                               href="{{ Request::fullUrlWithQuery(['sort_field' => 'H_UpdDate', 'sort_direction' => $sort_direction]) }}">Updated</a>
                            <br />
                            <a
                               href="{{ Request::fullUrlWithQuery(['sort_field' => 'H_UpdUser', 'sort_direction' => $sort_direction]) }}">Updated
                                By</a>
                        </th>
                        <th></th>
                    </tr>
        ...
        <div class="row">
            ...
            <div class="col-6 col-md-2">
                <x-form.select name="facilityformid"
                               :options="$facilityformsselects"
                               empty=" " />
            </div>
            <div class="col-6 col-md-2">
                <x-form.button>Submit</x-form.button>
