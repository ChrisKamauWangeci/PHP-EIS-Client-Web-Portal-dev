<x-user-layout title="">
    ...
    <div id="app"
        ...
        <form method="post"
              action="{{ route('user.hospitals.store') }}"
              id="hospitalform">
            @csrf
            ...
            <div class="row">
                ...
                <div class="col-sm-3 py-1">
                    <x-form.input name="H_ReceiveMethodEmail"
                                  ...
                                  :value="old('H_ReceiveMethodEmail')"
                                  maxlength="50" />
                </div>
