<x-user-layout title="">
    ...
    <div class="row">
        ...
        <div class="col-6 text-end">
            <a href="{{ route('user.alternatepayments.create') }}"
    ...
    <form method="get"
          ...
          id="searchform"
          action="{{ route('user.alternatepayments.index') }}">
    ...
    <div class="table-responsive">
        <table class="table table-sm table-hover table-bordered w-auto">
            <thead>
                <tr>
                    <th><a
                           href="{{ Request::fullUrlWithQuery(['sort_field' => 'A_CopyService', 'sort_direction' => $sort_direction]) }}">Copy
                            Service</a></th>
                    <th>Address</th>
                    <th>City</th>
                    <th>State</th>
                    <th>Zip</th>
                    <th><a
                           href="{{ Request::fullUrlWithQuery(['sort_field' => 'A_Phone', 'sort_direction' => $sort_direction]) }}">Phone</a>
                    </th>
                    <th><a
                           href="{{ Request::fullUrlWithQuery(['sort_field' => 'A_Fax', 'sort_direction' => $sort_direction]) }}">Fax</a>
                    </th>
                    <th>Update Date</th>
                    <th></th>
                </tr>
                        ...
                        <td class="actions">
                            @if ($postname)
                                <button class="btn btn-xs btn-success"
                                        onclick="post_value('{{ $alternatepayment->A_CopyService }}');">Select</button>
                            @endif
                            <a href="{{ route('user.alternatepayments.show', $alternatepayment->A_ID) }}"
