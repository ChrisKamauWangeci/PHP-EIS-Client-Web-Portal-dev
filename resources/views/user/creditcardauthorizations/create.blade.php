<x-user-layout title="">
    ...
    <div class="row">
        <div class="col-auto">
            <h1>Create Credit Card Authorization: {{ $workorder->W_WorkOrder }} - {{ $workorder->W_FirstName }}
    ...
    <div class="row">
        <div class="col-sm-6">
            ...
            <form method="post"
                  action="{{ route('user.creditcardauthorizations.store') }}">
                @csrf
