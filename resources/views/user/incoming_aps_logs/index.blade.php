<x-user-layout title="">
    ...
    <form method="get"
          ...
          id="searchform"
          action="{{ route('user.incoming_aps_logs.index') }}">
        ...
        <div class="row">
            ...
            <div class="col-6 col-sm-4 col-md-3 col-lg-2 pt-2">
                <x-form.input name="new_file"
                              id="new_file"
                              label="New File"
                              :value="request('new_file')" />
            </div>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            @if (file_exists('//FTPSERVER/ftpserver/OCRData/EIS/pending/ready/' . $incomingApsLog->new_file))
                                <a href="/user/workorderfiles/file?file={{ urlencode('//FTPSERVER/ftpserver/OCRData/EIS/pending/ready/' . $incomingApsLog->new_file) }}&amp;download=0"
                                   target="_blank"
                                   title="{{ '//FTPSERVER/ftpserver/OCRData/EIS/pending/ready/' . $incomingApsLog->new_file }}"><span
                                          class="badge bg-success">ready</span></a>
                            @endif
                            @if (file_exists('//FTPSERVER/ftpserver/OCRData/EIS/pending/review/' . $incomingApsLog->new_file))
                                <a href="/user/workorderfiles/file?file={{ urlencode('//FTPSERVER/ftpserver/OCRData/EIS/pending/review/' . $incomingApsLog->new_file) }}&amp;download=0"
                                   target="_blank"
                                   title="{{ '//FTPSERVER/ftpserver/OCRData/EIS/pending/review/' . $incomingApsLog->new_file }}"><span
                                          class="badge bg-warning">review</span></a>
                            @endif
                        </td>
                        ...
                        <td>
                            <a href="{{ route('user.incoming_aps_logs.show', $incomingApsLog->id) }}"
