<x-user-layout title="">
    ...
    <!-- Upload Progress Bar -->
    <div id="uploadProgressWrapper" style="position: fixed; top: 1rem; right: 1rem; width: 300px; display: none; z-index: 1100;">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.body.addEventListener('htmx:xhr:loadstart', function(evt) {
                if (!evt.target.closest('form')) return;
            ...
            document.body.addEventListener('htmx:xhr:progress', function(evt) {
                ...
                if (percent === 100) wrapper.style.display = 'none';
            });
        });
    </script>
    ...
    <div id="authorizationSectionWrapper">
        ...
        <div id="authorizationSection" class="toggle-content" style="display:none;">
            ...
            <div class="col-sm-5">
                ...
                <form
                    hx-post="{{ route('user.workorderfiles.fileupload', $workorder->W_WorkOrder) }}"
                    hx-swap="outerHTML"
                    hx-target="#authorizationSectionWrapper"
                    hx-select="#authorizationSectionWrapper, #flash-wrapper"
    ...
    <div id="requestfilesSection" class="toggle-content" style="display:none;">
        ...
        <button
            hx-swap="outerHTML"
            hx-target="#requestfilesSection"
            hx-select="#requestfilesSection, #flash-wrapper"
            hx-get="/user/workorderfiles/createrequestfile?W_WorkOrder={{ $workorder->W_WorkOrder }}&type=nolor&requestnote=1st"
            hx-trigger="click"
        ...
        <button
            ...
            hx-target="#requestfilesSection"
            hx-select="#requestfilesSection, #flash-wrapper"
            hx-get="/user/workorderfiles/createrequestfile?W_WorkOrder={{ $workorder->W_WorkOrder }}&type=nolor&requestnote=2nd"
            hx-trigger="click"
            hx-disabled-elt="self"
            class="btn btn-sm btn-success request-btn">
            Generate 2nd (HTMX)
        ...
        <button
            ...
            hx-target="#requestfilesSection"
            hx-select="#requestfilesSection, #flash-wrapper"
            hx-get="/user/workorderfiles/createrequestfile?W_WorkOrder={{ $workorder->W_WorkOrder }}&type=nolor&requestnote=3rd"
            hx-trigger="click"
            hx-disabled-elt="self"
            class="btn btn-sm btn-success request-btn">
            Generate 3rd (HTMX)
    ...
    <div id="notefilesSection" class="toggle-content" style="display:none;">
        ...
        <div class="col-sm-5">
            ...
            <form
                hx-post="{{ route('user.workorderfiles.fileupload', $workorder->W_WorkOrder) }}"
                hx-swap="outerHTML"
                hx-target="#notefilesSection"
                hx-select="#notefilesSection, #flash-wrapper"
                hx-encoding="multipart/form-data"
                method="post"
                enctype="multipart/form-data"
                action="{{ route('user.workorderfiles.fileupload', $workorder->W_WorkOrder) }}">
    ...
    <div id="reviewapsfilesSection" class="toggle-content" style="display:none;">
        ...
        <div class="col-sm-5">
            ...
            <form
                hx-post="{{ route('user.workorderfiles.fileupload', $workorder->W_WorkOrder) }}"
                hx-swap="outerHTML"
                hx-target="#reviewapsfilesSection"
                hx-select="#reviewapsfilesSection, #flash-wrapper"
                hx-encoding="multipart/form-data"
                method="post"
                enctype="multipart/form-data"
                action="{{ route('user.workorderfiles.fileupload', $workorder->W_WorkOrder) }}">
