<x-emailseqster>
    ...
    <br />
    <br />
    As part of your application process, we need to review your medical records. With your consent, these records can be quickly and securely shared with {{ $ehrworkorder->R_Company ?? '' }} through our trusted partner, EIS/SEQSTER.
    <br />
    <br />
            ...
            <tr>
                <td align="center" style="padding: 10px;">
                    <table cellspacing="0" cellpadding="0" border="0">
                        <tr>
                            <td align="center" bgcolor="#aa0000" style="background-color: #aa0000; margin: auto; max-width: 600px; border-radius: 4px; padding: 15px 20px;" width="100%">
                                <a href="https://www.expressimagingservices.com/seqsterorders/step1/{{ $seqsterorder->uuid }}" target="_blank" style="font-size: 15px; color: #ffffff; font-weight:bold; text-align:center; background-color: #aa0000; text-decoration: none; border: none; border-radius: 4px; display: inline-block;">
