    <x-emailseqster>
        ...
        <br />
        <br />
        I am contacting you on behalf of Northwestern Mutual and your financial advisor, {{ $data['financialAdvisor'] ?? '' }}.
        <br />
        ...
        <br />
        We reached out a few days ago to request your assistance in obtaining your medical records from Veterans Affairs (VA).
        As of the date and time of this message, it does not appear you have provided the approval needed to release your VA medical record.
        ...
        If approval is not provided in the next two days, we will reach out to the VA medical records department to pursue the records by the traditional method, which can take up to 40 days or more.
        <br />
        <br />
        <br />
        ...
        <small>
            ...
            <br />
            <br />
            Copyright © 2025. The Northwestern Mutual Life Insurance Company. All Rights Reserved. Northwestern Mutual® is a trademark of The Northwestern Mutual Life Insurance Company.
