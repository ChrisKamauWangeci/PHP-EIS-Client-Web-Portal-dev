...
class ContractorloginController extends Controller
{
    ...
    //     return view('user.contractorlogins.index', compact('contractorlogins', 'sort_direction', 'contractors'));
    // }
    ...
    public function stats(Request $request)
    {
        ...
        if ($days_difference < 0) {
            return redirect()
                ->route('user.contractorlogins.stats')
        ...
        return view('user.contractorlogins.stats', compact('contractorlogins', 'contractors', 'from', 'to'));
    }
    ...
    public function statsdaily(Request $request)
    {
        ...
        return view('user.contractorlogins.statsdaily', compact('contractorlogins', 'totals', 'contractorSummaries', 'contractors', 'from', 'to'));
    }
}
