...
class UpdateCompanyRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'C_WebID' => ['required', 'string', 'min:3', 'max:50', 'unique:Company,C_WebID,' . $this->company->id . ',id'],
            ...
            'C_eHealthLink' => ['nullable', 'boolean'],
            'summary' => ['nullable', 'boolean'],
            'smartaccess_active' => ['nullable', 'boolean'],
            'caremap360_active' => ['nullable', 'boolean'],
        ];
    }
